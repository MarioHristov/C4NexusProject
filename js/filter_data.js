...
async function fetchData() {
    const data = (await fetch('https://c4-nexus-project.vercel.app/json_data/products.json')).ok ? await data.json() : await fetch('http://192.168.0.104:8080/json_data/products.json').json();
